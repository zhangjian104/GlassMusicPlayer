        ...
        <section class="mb-6 px-4">
            <div class="mb-4 flex items-center justify-between">
                <h2 class="section-title">
                    ...
                    >
                        <span class="icon-[mdi--playlist-star] text-primary h-4 w-4" />
                    </span>
            ...
            <div class="grid grid-cols-3 gap-3">
                <div v-for="i in 6" :key="i" class="group">
                    <div class="relative mb-2 aspect-square overflow-hidden rounded-xl">
                        ...
                        <div class="animate-shimmer absolute inset-0"></div>
                        <div
                            class="skeleton-bar absolute top-1.5 right-1.5 h-3 w-10 rounded-full"
                        ></div>
                        <div
                            class="skeleton-strong absolute bottom-1.5 left-1.5 h-6 w-6 rounded-full"
                        ></div>
                    </div>
        ...
        <section class="mb-6">
            <div class="mb-3 flex items-center justify-between px-4">
                <h2 class="section-title">
                    ...
                    >
                        <span class="icon-[mdi--account-music] text-primary h-4 w-4" />
                    </span>
        ...
        <section class="mb-6 px-4">
            <div class="mb-4 flex items-center justify-between">
                <h2 class="section-title">
                    ...
                    >
                        <span class="icon-[mdi--music-note-plus] text-primary h-4 w-4" />
                    </span>
        ...
        <section class="px-4 pb-6">
            <div class="mb-4 flex items-center justify-between">
                <h2 class="section-title">
                    ...
                    >
                        <span class="icon-[mdi--video] text-primary h-4 w-4" />
                    </span>
